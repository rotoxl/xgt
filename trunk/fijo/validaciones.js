...
function _formatearFechaRelativa(xfecha, anhadirSegundos){	
...
function formatearFechaRelativaConSegundos(xfecha){	
	return _formatearFechaRelativa(xfecha, true)
	}
function formatearFechaRelativa(xfecha){	
	return _formatearFechaRelativa(xfecha, false)
	}
