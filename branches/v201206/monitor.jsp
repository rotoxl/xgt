...
<SCRIPT TYPE="text/javascript">
	...
	MonitorSQL.prototype.montaDivUsu=function (cont, cdApli, usu){
		...
		if (idSesion!='-1'){
			var spanHoraConexion=creaObjProp('span', {className:'horaConexion', title:'Inicio de sesión', texto:formatearFechaRelativa(horaConexion) })
			var spanHoraDesconexion=creaObjProp('span', {className:'horaConexion desconexion', title:'Último acceso', texto:formatearFechaRelativa(horaDesconexion) })
