...
Control.prototype.dimensiones=function(){
	...
	if (ctl) {
		if (!this.esContenedor) {
			...
			//~ panel2.style.visibility='hidden'; panel2.style.display='block'
...
Disenhador.prototype.cambiaModoDisenho=function(estado){
	...
	if (this.modoDisenho){
		...
		var xthis=this
		setTimeout(function (){xthis.ajustaAlturaArbol()}, 500)
		setTimeout(function (){exp.onResize(false)}, 100)
		}
	else {
...
Disenhador.prototype.montaBarraHerramientas=function(){
	...
	var txtcolorFondo=creaObjProp('input', {type:'text', id:'txtcolorFondo',className:'colorPicker',value:'#FFFFFF'})
	jwerty.key('enter', fnColorFondo, null, $(txtcolorFondo))
	...
	var txtcolorFrente=creaObjProp('input', {type:'text', id:'txtcolorFrente',className:'colorPicker',value:'#000000'})
	jwerty.key('enter', fnColorFrente, null, $(txtcolorFrente))
	...
	$('#splitterV').css('width', $('#botoneraDisenho').offset().left)
}
...
Disenhador.prototype.creaH3yDIV=function(idDiv, ds, cont){
	var h3=creaObjProp('div', {className:'header', 'texto':ds, title:'[Click para mostrar u ocultar el panel "'+ds+'"]', onclick:function(){disenhador.alternaVisible(idDiv)}}) 
	...
	if (disp==false) 
		this.alternaVisible(idDiv, false)
...
Disenhador.prototype.alternaVisible=function(idPanel, forzar){
	...
	this.ajustaAlturaArbol()
}
Disenhador.prototype.ajustaAlturaArbol=function(){
...
function FormularioEditorMenu(idxBloqueo){
	Frm.call(this, 'editorMenus', idxBloqueo)
	...
	var cmdAceptar=creaObj('button', 'cmdgt aceptar', null, 'Aceptar', function(){editorMenu.acepta()})
	var cmdCancelar=creaObj('button', 'cmdgt cancelar', null, 'Cancelar', function(){ editorMenu.cancela() }) 
...
FormularioEditorMenu.prototype.nuevo=function(){
	...
	m.cd_boton=null
	m.tipoPanel1='1'; m.botonera=true; m.disposicion='v'
	this.menuActivo=m
	this.editar()
	}
...
FormularioEditorMenu.prototype.datosFRM=function(){
	...
	return {numTramites:0, camino : 0, tramite:0, titulo: 'Propiedades del menú #'+this.menuActivo.cd_boton, tipo : 'frm', controles:[
				...
				{tipo : 'lvwConsejo',id : 'sinnombre1', ds : 'Posición', tipoConsejo:'titulo titulo1'},
				...
				{tipo : 'lvwConsejo',id : 'sinnombre2', ds : 'Estética', tipoConsejo:'titulo titulo1'},
				...
				{tipo : 'lvwConsejo',id : 'sinnombre3', ds : 'Comportamiento', tipoConsejo:'titulo titulo1'},
					{tipo : 'lvwConsejo',id : 'sinnombre31', ds : 'Tarea', tipoConsejo:'titulo titulo2'},
						...
						{'tipo' : 'lvwConsejo','id' : 'sinnombre92z82','maxlength' : 0,'valor' : '','bloqueado' : false,'validacion' : '','ds' : 'Trámite existente', tipoConsejo:'titulo titulo3'},
						...
						{'tipo' : 'lvwConsejo','id' : 'sinnombre9zz282','maxlength' : 0,'valor' : '', 'bloqueado' : false,'validacion' : '','ds' : 'Trámite nuevo (se incluirá en TRA_TramitesObjetos y en TRA_Acciones)', tipoConsejo:'titulo titulo3'},
					...
					{tipo : 'lvwConsejo',id : 'sinnombre32', ds : 'Vista', tipoConsejo:'titulo titulo2'},
					...
					{tipo : 'lvwConsejo',id : 'sinnombre33', ds : 'Enlace a página Web', tipoConsejo:'titulo titulo2'},
						{tipo: 'lvw','id' : 'url', 'maxlength' : -100,'valor':menu.url,'bloqueado' : false, 'ds' : 'URL'},
						
				{tipo : 'lvwConsejo',id : 'sinnombre4', ds : 'Información de grupo o perfil', tipoConsejo:'titulo titulo1'},
						...
						{tipo:'lvw', id:'tipo.nuevo', maxlength:-30, valor:menu.esNuevo?'menuglobal':null, bloqueado:false, 'ds':'Grupo/perfil nuevo'},
			]}
	}
